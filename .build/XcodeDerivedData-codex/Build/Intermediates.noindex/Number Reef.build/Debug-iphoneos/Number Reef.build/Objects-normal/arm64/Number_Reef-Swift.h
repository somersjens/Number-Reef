...
#ifndef NUMBER_REEF_SWIFT_H
#define NUMBER_REEF_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Number_Reef",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Number_Reef8AppAudio")
...
@class AVAudioPlayer;
@interface AppAudio (SWIFT_EXTENSION(Number_Reef)) <AVAudioPlayerDelegate>
...
@class UIApplication;
@class UIWindow;
/// The game is portrait-only. iPad has to <em>declare</em> every orientation, so the
/// lock is applied here at runtime instead — <code>UIRequiresFullScreen</code>, the old
/// way of saying this, is deprecated and will stop being honoured.
SWIFT_CLASS("_TtC11Number_Reef11AppDelegate")
...
SWIFT_CLASS("_TtC11Number_Reef19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(Number_Reef)) <UNUserNotificationCenterDelegate>
