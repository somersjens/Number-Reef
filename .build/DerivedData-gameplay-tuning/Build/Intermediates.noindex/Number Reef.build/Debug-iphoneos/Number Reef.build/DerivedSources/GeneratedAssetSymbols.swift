...
extension DeveloperToolsSupport.ImageResource {
    ...
    /// The "2x_coin_fish" asset catalog image resource.
    static let _2XCoinFish = DeveloperToolsSupport.ImageResource(name: "2x_coin_fish", bundle: resourceBundle)
    ...
    /// The "life_fish" asset catalog image resource.
    static let lifeFish = DeveloperToolsSupport.ImageResource(name: "life_fish", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "2x_coin_fish" asset catalog image.
    static var _2XCoinFish: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: ._2XCoinFish)
#else
        .init()
#endif
    }
    ...
    /// The "life_fish" asset catalog image.
    static var lifeFish: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .lifeFish)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "2x_coin_fish" asset catalog image.
    static var _2XCoinFish: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: ._2XCoinFish)
#else
        .init()
    ...
    /// The "life_fish" asset catalog image.
    static var lifeFish: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .lifeFish)
#else
        .init()
